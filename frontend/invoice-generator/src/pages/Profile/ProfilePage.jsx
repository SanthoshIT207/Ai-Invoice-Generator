...
//       <Input label="Full Name" name="name" icon={User} type="text" value={formData.name} onChange={handleInputChange} placeholder="Enter your full name" />
...
//           <InputField label="Business Name" name="businessName" icon={Building} type="text" value={formData.businessName} onChange={handleInputChange} placeholder="SS Cable and Internet Provider" />
...
//           <InputField label="Phone" name="phone" icon={Phone} type="tel" value={formData.phone} onChange={handleInputChange} placeholder="(944) 373-7239" />
//           </div>
//           </div>
          ...
          <div className="pt-6 border-t border-slate-200">
            ...
            <div className="space-y-4">
              <InputField
                ...
                onChange={handleInputChange}
                placeholder="SS Cable and Internet Provider"
              />
