              ...
              <div className="flex flex-col sm:flex-row justify-between items-start pb-8 border-b border-slate-200"> 
                ...
                <div className="text-left sm:text-right mt-4 sm:mt-0"> 
                  ...
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                    ...
                    invoice.status === 'Pending' ?  'bg-amber-100 text-emerald-800' :
                  ...
                  <div className="grid grid-cols sm:grid-cols-2 gap-8 my-8"> 
                    <div> 
                    ...
                    <div className="sm:text-right"> 
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 my-8"> 
                        ...
                        <div> 
                          <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-">Due Date</h3>
                          <p className="font-medium text-slate-800">{new Date(invoice.dueDate).toLocaleDateString()}</p>
                        </div>
                        <div> 
                          <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-">Payment Terms</h3>
                        ...
                        <table className="w-full divide-y divide-slate-200"> 
                          ...
                          <tbody className="bg-white divide-y divide-slate-200"> 
                            {invoice.items.map((item, index) => (
                              ...
                              <td className="px-4 sm:px-6 py-4 text-center font-medium text-slate-900">{item.quantity}</td>
                              <td className="px-4 sm:px-6 py-4 text-right font-medium text-slate-900">${item.unitPrice.toFixed(2)}</td>
                          ...
                          <div className="flex justify-end mt-8">
                              <div className="w-full max-w-sm space-y">
