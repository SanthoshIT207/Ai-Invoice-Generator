...
const DashboardLayout = ({ children, activeMenu }) => {
  ...
  // moved debug after state declarations so isMobile/sidebarOpen exist
  console.log("DEBUG useAuth in DashboardLayout:", { user, logout, isMobile, sidebarOpen });
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {isMobile && sidebarOpen && (
        <div
          className="fixed inset-0 flex-col transition-all duration-300"
