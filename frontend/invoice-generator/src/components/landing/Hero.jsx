    ...
    <section className="relative bg-[#fbfbfb] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-lg sm:text-4xl lg:text-6xl font-extrabold text-blue-950 leading-tight mb-6">
        ...
        <div className="mt-12 sm:mt-16 relative max-w-5xl mx-auto">
          <img
            ...
            className="rounded-2xl shadow-2xl w-full shadow-gray-300 border-4 border-gray-200"
          />
        </div>
      </div>
    </section>
